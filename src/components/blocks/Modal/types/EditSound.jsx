    ...
    <div className="modal" onClick={onClose}>
      <div className="modal_content" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="inputs">
            <div className="id_wrapper input_wrapper">
              ...
              <p className="input__description">
                This is used to identify the sound in the system. This will
                matter in a future update (wink wink).
              </p>
              <input
                type="text"
                className="id__input"
            ...
            <div className="title_wrapper input_wrapper">
              <label htmlFor="sound-title" className="title__label">
                Name:
              </label>
              <p className="input__description">
                This is used as the name for the sound when you launch the
                board. Make this whatever you want.
              </p>
              {noTitle ? (
                <p className="input__error">Please input a title</p>
              ) : (
                <></>
              )}
              <input
            ...
            <div className="file_wrapper input_wrapper">
              <label htmlFor="sound-file" className="sound__label">
                File:
              </label>
              <p className="input__description">
                This is the audio file that is uploaded to the server, so that
                you play it when you launch a board. If you don't wan't to
                change it, just leave it blank.
              </p>
              {noAudio ? (
                <p className="input__error">Please upload an audio file</p>
              ) : (
                <></>
              )}
              <input
              ...
              <audio id="file-preview" controls onLoadedMetadata={getDuration}>
                <source
        ...
        <div className="modal__footer">
          <Btn content="Delete" extraClasses="modal__btn" onClick={onDelete} />
          <Btn content="Cancel" extraClasses="modal__btn" onClick={onClose} />
          <Btn
